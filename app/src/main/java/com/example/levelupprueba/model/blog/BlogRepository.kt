    ...
    fun obtenerBlogs(): List<Blog> {
        return listOf(
            Blog(
                ...
                categoria = "noticias",
                imagenUrl = "https://example.com/ps5pro.jpg",
                autor = "Miguel Torres",
            ...
            Blog(
                ...
                categoria = "guias",
                imagenUrl = "https://example.com/setup.jpg",
                autor = "Ana López",
            ...
            Blog(
                ...
                categoria = "comunidad",
                imagenUrl = "https://example.com/esports.jpg",
                autor = "Carlos Rivera",
            ...
            Blog(
                ...
                categoria = "noticias",
                imagenUrl = "https://example.com/lanzamientos.jpg",
                autor = "María Torres",
            ...
            Blog(
                ...
                categoria = "noticias",
                imagenUrl = "https://example.com/mobile.jpg",
                autor = "Level Up Team",
                fechaPublicacion = "15 Dic 2024",
            ...
            Blog(
                ...
                categoria = "noticias",
                imagenUrl = "https://example.com/vr.jpg",
                autor = "Ana López",
